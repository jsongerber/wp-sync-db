          ...
          <tbody>
            ...
            <?php if ($is_default_profile) : ?>
              <tr class="replace-row ui-state-default">
                ...
                <td class="old-replace-col">
                  <input type="text" size="40" name="replace_old[]" class="code" id="old-full-url" placeholder="Old URL" value="<?php echo htmlentities(home_url()); ?>" autocomplete="off" />
                </td>
                <td class="arrow-col">
                  <span class="right-arrow">&rarr;</span>
                </td>
                <td class="replace-right-col">
                  <input type="text" size="40" name="replace_new[]" class="code" id="new-full-url" placeholder="New URL" autocomplete="off" />
